...
def indexView(request):
    ...
    if request.method == 'POST' and 'file' in request.FILES:
        ...
        result=openaiResponse(text_prompt + "Puedes dar formato a la información proporcionada utilizando HTML para mejorar su presentación solo el contenido que debo pegar dentro del elemento <body> de mi página HTML osea dame la respuesta en html con stilos tambien ")['choices'][0]['message']['content']
